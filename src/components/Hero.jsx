          ...
          <div className="flex flex-col md:flex-row items-center justify-around">
            ...
            <div className="w-full md:w-2/5 md:pl-12 ">
              <div className="bg-white bg-opacity-10 backdrop-filter md:backdrop-blur-lg relative  rounded-xl p-8 shadow-2xl">
                <h2 className="text-2xl font-semibold mb-6">Why Choose Tech Sillies?</h2>
                {/* <img
                ...
                <ul className="space-y-4">
                  <li className="flex items-center">
                    ...
                    <span>Real People, Not Bots</span>
                  </li>
                  <li className="flex items-center">
                    <svg
                    ...
                    <span>Private & Respectful by Design</span>
                  </li>
                  <li className="flex items-center">
                    <svg
                    ...
                    <span>More Than Just dating</span>
                  </li>
                </ul>
              </div>
            </div>
